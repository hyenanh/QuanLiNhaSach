...
namespace QLNS_GiaodienSach
{
    public partial class fChinhSuaTaiKhoan : Form
    {
        ...
        {
            string queryTimKiem = "SELECT MaTK 'Mã Tài Khoản', TenDN 'Tên Đăng Nhập', HoTenNV 'Họ tên Nhân viên' , GioiTinh 'Giới Tính', NgaySinh 'Ngày Sinh', DiaChi 'Địa Chỉ', SDT 'SĐT', Email, TenPhanQuyen 'Tên Phân Quyền'" +
                                  " FROM PHANQUYEN, TAI_KHOAN" +
