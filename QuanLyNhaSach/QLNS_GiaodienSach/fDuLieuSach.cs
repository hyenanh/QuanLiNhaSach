...
namespace QLNS_GiaodienSach
{
    public partial class fDuLieuSach : Form
    {
        ...
        { 
            ...
            string queryHienThiSanPham = "SELECT SACH.MaSach 'Mã Sách', TenSach 'Tên Sách', TenTL 'Tên Thể Loại', TacGia 'Tác Giả', DonGiaNhap 'Đơn Giá Nhập', DonGiaBan 'Đơn Giá Bán', SoLuongTon 'Số Lượng Tồn'" +
        ...
        {
            string queryTimKiem = "Select SACH.MaSach 'Mã Sách', TenSach 'Tên Sách', TenTL 'Tên Thể Loại', TacGia 'Tác Giả', DonGiaNhap 'Đơn Giá Nhập', DonGiaBan 'Đơn Giá Bán', SoLuongTon 'Số Lượng Tồn'" +
                " from SACH, THE_LOAI, CTTL" +
        ...
        private void cbbTheLoai_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string queryChonTheLoai = "Select SACH.MaSach 'Mã Sách', TenSach 'Tên Sách', TenTL 'Tên Thể Loại', TacGia 'Tác Giả', DonGiaNhap 'Đơn Giá Nhập', DonGiaBan 'Đơn Giá Bán', SoLuongTon 'Số Lượng Tồn'" +
               " from SACH, THE_LOAI, CTTL" +
               " where SACH.MaSach=CTTL.MaSach AND CTTL.MaTL=THE_LOAI.MaTL AND" +
